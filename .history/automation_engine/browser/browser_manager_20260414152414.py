...
if __name__ == "__main__":
    ...
    chrome_user_data = os.getenv(
        ...
        r"C:\Users\HP\AppData\Local\Google\Chrome\User Data\Default"
    )
    ...
    try:
        ...
        # For testing with detach=True, browser may stay open visually.
        # You can uncomment the next line when you want full auto-close behavior.
        # manager.close_browser(driver)
        pass