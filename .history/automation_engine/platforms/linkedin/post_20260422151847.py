...
def post_to_linkedin(driver, post):
    ...
    try:
        ...
        print("Finding LinkedIn editor...")
        textbox = None

        try:
            clicked_editor = driver.execute_script("""
                ...
                return false;
            """)
            print("Placeholder/editor click attempted:", clicked_editor)
        except Exception as e:
            print("⚠️ Placeholder/editor click JS failed:", str(e))
        ...
        try:
            textbox = driver.execute_script("""
                ...
                if (active && isVisible(active)) {
                    ...
                    const cls = (active.className || "").toString().toLowerCase();

                    if (ce === "true" || role === "textbox" || cls.includes("ql-editor")) {
                        return active;
                    }
                }
            ...
            print("⚠️ Active editor JS failed:", str(e))
