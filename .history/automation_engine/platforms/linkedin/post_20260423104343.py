...
def post_to_linkedin(driver, post):
    ...
    try:
        ...
        try:
            ...
            [{
	"resource": "/d:/blockchain_internshipe/Autosocial_ai/automation_engine/platforms/linkedin/post.py",
	"owner": "Pylance7",
	"severity": 8,
	...
	"severity": 4,
	"message": "\"find_photo_button\" is not defined",
	"source": "Pylance",
	"startLineNumber": 200,
	"startColumn": 17,
	"endLineNumber": 200,
	...
	"severity": 4,
	"message": "\"find_image_input\" is not defined",
	"source": "Pylance",
	"startLineNumber": 212,
	"startColumn": 18,
	"endLineNumber": 212,
	...
	"origin": "extHost1"
        ...
        # optional feed/profile verification
        try:
            driver.get("https://www.linkedin.com/feed/")
            time.sleep(5)
