    ...
    for i in range(retries):
        try:
            ...
            result = driver.execute_script("""
                ...
                // 2. Use the actual textbox element from Selenium
                if (!textbox) {
                ...
                // 3. Geometric search near passed textbox
            ...
            # if textbox became stale, refetch it next loop
            try:
                _ = textbox.tag_name
            except Exception:
                textbox = None
...
def post_to_linkedin(driver, post):
    ...
    try:
        ...
        if not is_composer_open(driver, tex):
