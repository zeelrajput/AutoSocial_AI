...
try:
    schedule_popup = driver.execute_script("""
        const bodyText = (document.body.innerText || '').toLowerCase();
        return bodyText.includes('schedule post') &&
...
if schedule_popup:
    return {"success": False, "message": "Wrong button clicked: Schedule post popup opened instead of actual Post"}
