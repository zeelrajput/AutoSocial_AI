...
def activate_linkedin_composer(driver):
    """
    Instead of finding textbox by selector, click the visible modal/body area
    and then type into active element.
    """
    xpath_candidates = [
        "//div[@role='dialog']",
        ...
        "//div[contains(., 'What do you want to talk about?')]",
    ]
        ...
        try:
            ...
            for el in elements:
                try:
                    ...
                    print("Composer container activated using:", xpath)
                    time.sleep(2)
                    return True
                except Exception:
                    continue
    ...
    try:
        driver.execute_script("""
            ...
            if (el) el.click();
        """)
        print("Composer activated using center click fallback")
        time.sleep(2)
        return True
    except Exception:
        return False
