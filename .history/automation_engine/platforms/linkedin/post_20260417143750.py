    ...
    while time.time() < end_time:
        ...
        for dialog in dialogs:
            try:
                ...
                # 2. Look for the editor inside the dialog
                # We target 'ql-editor' which is the standard LinkedIn rich text class
                # Or 'role=textbox' which is the accessibility standard
                editor_xpaths = [
