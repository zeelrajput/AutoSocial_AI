...
from automation_engine.common.screenshot_helper import save_screenshot
from automation_engine.common.human_behavior import medium_pause
from automation_engine.platforms.linkedin.selectors import  TEXTBOX_XPATHS, POST_BUTTON_XPATHS


def post_to_link(driver, post):
    try:
        ...
        post_button = None
        for selector in POST_BUTTON_XPATHS:
            try:
