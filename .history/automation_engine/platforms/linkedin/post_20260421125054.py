...
def post_to_linkedin(driver, post):
    try:
        ...
        # 1. Open Profile and Find Activity
        ...
        # --- STEP 4: HANDLE THE "SAVE DRAFT" MODAL (The Fix) ---
        short_pause(2)
        try:
            # Look for the 'Discard' button on the popup shown in your screenshot
            ...
            for btn in draft_modal_discard:
                if is_visible(driver, btn):
                    print("⚠️ 'Save draft' modal detected. Clearing it now...")
        ...
        for attempt in range(4):
            ...
            if post_button:
                # Force scroll to the bottom of the modal to ensure visibility
        ...
        if not post_button:
            ...
            return {"success": False, "message": "LinkedIn post button not found after typing."}
