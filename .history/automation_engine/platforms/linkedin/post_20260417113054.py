...
def find_start_post_button(driver):
    ...
    # Strong XPath fallbacks
    xpath_candidates = [
        "//div[contains(@class,'share-box-feed-entry__trigger')]",
        "//button[@aria-label='Start a post']",
        "//button[contains(@aria-label,'Start a post')]",
        "//div[@role='button' and contains(@aria-label,'Start a post')]",
        "//span[contains(normalize-space(),'Start a post')]/ancestor::div[@role='button'][1]",
        "//div[contains(normalize-space(),'Start a post')]/ancestor::div[@role='button'][1]",
    ]
