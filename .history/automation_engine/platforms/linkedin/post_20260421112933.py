...
def find_post_button(driver, timeout=10):
    ...
    while time.time() < end_time:
            ...
            try:
                ...
                for btn in elements:
                    try:
                        ...
                        print(f"✅ Post button found using XPath: {xpath}")
        ...
        # JS fallback: search visible enabled dialog buttons with text/aria Post
        try:
            found = driver.execute_script("""
                const visible = (el) => {
                    if (!el) return false;
            ...
            if found:
                ...
                print("Post button HTML:", get_outer_html(driver, found))
                return found
        except Exception as e:
