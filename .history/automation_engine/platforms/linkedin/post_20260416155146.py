...
from automation_engine.platforms.linkedin.selectors import POST_BUTTON_SELECTORS
        ...
        try:
            ...
            for el in elements:
                try:
                    ...
                    print("Start-post candidate found:", xpath)

                    # Try nearest clickable parent first
                    ...
                    if clickable:
                        print("Using clickable parent for Start post")
                        return clickable
