...
def post_to_linkedin(driver, post):
    ...
    try:
        ...
        # try a second click if modal did not open immediately
        ...
        print("Finding textbox after Start Post click...")
        ...
        try:
            ...
            try:
                driver.execute_script("arguments[0].focus(); arguments[0].click();", textbox)
                time.sleep(1)
            except Exception:
                pass
