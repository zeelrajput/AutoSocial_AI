...
def find_linkedin_textbox(driver):
    xpath_candidates = [
        ...
        "//div[@contenteditable='true' and @aria-multiline='true']",
            ...
            for el in elements:
                try:
                    if el.is_displayed():
                        ...
                        print("LinkedIn textbox found using XPath:", xpath)
                        print("Textbox outerHTML:", outer[:500])
                        return el
                except Exception:
                    continue
        except Exception:
...
def post_to_linkedin(driver, post):
    try:
        ...
        try:
            print("Editable elements found:", len(driver.find_elements(By.XPATH, "//div[@contenteditable='true']")))
        except Exception:
            pass
