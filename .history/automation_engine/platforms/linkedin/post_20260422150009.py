...
def post_to_linkedin(driver, post):
    ...
    try:
        ...
        print("Finding LinkedIn placeholder area first...")
        placeholder_clicked = False

        try:
            placeholder_clicked = driver.execute_script("""
            ...
            print("⚠️ Placeholder click JS failed:", str(e))

        print("Placeholder clicked:", placeholder_clicked)
        time.sleep(2)

        print("Getting active LinkedIn editor...")
        textbox = None
