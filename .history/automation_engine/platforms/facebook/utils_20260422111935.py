...
def wait_for_facebook_login(driver, timeout=180):
    ...
    while time.time() < end_time:
        try:
            ...
            if "two-factor" in current_url or "security code" in body_text:
...
def find_create_post_button(driver):
    return _find_displayed(driver, CREATE_POST_XPATHS, "Create post button")
