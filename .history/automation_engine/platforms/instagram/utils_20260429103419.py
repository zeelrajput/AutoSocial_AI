...
def find_create_button(driver, timeout=20):
    """
    Find Instagram Create button using XPath + JS fallbacks.
    """
    ...
    xpaths = [
        ...
        "//*[@aria-label='Create']/ancestor::a[1]",
        "//*[@aria-label='Create']/ancestor::*[@role='button'][1]",
        "//*[@aria-label='New post']/ancestor::a[1]",
        "//*[@aria-label='New post']/ancestor::*[@role='button'][1]",
        "//span[normalize-space()='Create']/ancestor::a[1]",
        "//span[normalize-space()='Create']/ancestor::*[@role='button'][1]",
        "//div[@role='button'][.//*[normalize-space()='Create']]",
    ...
    while time.time() < end_time:
        ...
        try:
            el = driver.execute_script(
                ...
                const nodes = Array.from(document.querySelectorAll("a, button, div[role='button'], [aria-label]"));
            ...
            if el:
                print("✅ Create button found using JS fallback")
                return el
