...
def post_to_instagram(driver, post):
    ...
    try:
        ...
        # verify success after share click
        # try:
        ...
        #     if (
        #         "write a caption" not in page_text
        #         and "crop" not in page_text
        #         and len(visible_dialogs) == 0
        #     ):
        #         return {"success": True, "message": "Instagram post successful"}

        #     return {"success": True, "message": "Instagram post likely successful"}

        # except Exception:
        #     return {"success": True, "message": "Instagram post may have been successful"}
