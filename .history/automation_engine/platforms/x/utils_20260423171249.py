...
# ✅ WAIT HELPERS (used for finding elements reliably)
from automation_engine.common.wait_helper import wait_for_visible, wait_for_clickable

# ✅ CLICK HELPER (safe click instead of direct click)
from automation_engine.common.click_helper import safe_click

# ✅ HUMAN TYPING (uses remove_non_bmp internally)
from automation_engine.common.type_helper import type_like_human

# ✅ HUMAN BEHAVIOR (random delay)
from automation_engine.common.human_behavior import small_pause, medium_pause

# ✅ FILE UPLOAD HELPER
from automation_engine.common.uplo_helper import upload_file
...
# ✅ OPEN HOME PAGE + HUMAN DELAY
def open_x_home(driver):
    driver.get("https://x.com/home")
    medium_pause()  # ✅ human behavior added


# ✅ CLICK COMPOSE BUTTON (OPTIONAL)
def click_compose_if_needed(driver):
    for selector in COMPOSE_SELECTORS:
        try:
            btn = wait_for_clickable(driver, By.CSS_SELECTOR, selector, timeout=5)  # ✅ wait helper
            if btn:
                safe_click(driver, btn)  # ✅ safe click
                print("✅ Compose button clicked:", selector)
                medium_pause()  # ✅ human delay
                return True
        except Exception:
            continue
    return False
...
def find_x_textbox(driver):
    for selector in TEXTBOX_SELECTORS:
        try:
            textbox = wait_for_visible(driver, By.CSS_SELECTOR, selector, timeout=10)  # ✅ wait helper
