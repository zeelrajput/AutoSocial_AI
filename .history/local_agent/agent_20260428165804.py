...
def run_task_silently(post_id, platform, caption, media):
    """
    Run automation while hiding internal terminal/debug logs.
    """

    with open(os.devnull, "w", encoding="utf-8") as devnull:
        with contextlib.redirect_stdout(devnull), contextlib.redirect_stderr(devnull):
            return run_task(post_id, platform, caption, media)
