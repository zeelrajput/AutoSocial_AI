...
PHOTO_BUTTON_XPATHS = [
    "//div[@role='dialog']//*[@aria-label='Add a photo']",
    "//div[@role='dialog']//*[normalize-space()='Photo']/ancestor::*[@role='button' or self::button][1]",
    "//span[normalize-space()='Photo']/ancestor::*[@role='button' or self::button][1]",
]
